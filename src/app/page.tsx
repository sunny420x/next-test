        ...
        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
          ...
          <dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col-reverse gap-1">
              ...
              <dd className="text-4xl font-semibold tracking-tight text-white">20 k</dd>
            </div>
          </dl>
        </div>
      </div>
        ...
        <ul role="list" className="grid gap-x-8 gap-y-12 sm:grid-cols-2 sm:gap-y-16 xl:col-span-2">
          <li>
            <div className="flex items-center gap-x-6">
              {/* <Image className="size-16 rounded-full" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80" alt="" /> */}
              <div>
                <h3 className="text-base/7 font-semibold tracking-tight text-gray-900">Sunny</h3>
                <p className="text-sm/6 font-semibold text-indigo-600">Co-Founder / Developer</p>
              </div>
              <div>
                <h3 className="text-base/7 font-semibold tracking-tight text-gray-900">TK Non</h3>
